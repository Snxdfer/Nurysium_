...
library:create_section("Auto Crates", 10709782497)
...
library:create_toggle("Visualizer", "World", function(toggled)
...
library:create_toggle("Anti Curve", "Combat", function(toggled)
...
library:create_toggle("Auto Explosion Crate", "Auto Crates", function(state)
	getgenv().AEC = state
end)
